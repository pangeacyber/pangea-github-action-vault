...
export function eventOrderAndStringifySubfields(obj) {
    const orderedEntries = Object.entries(obj).sort((a, b) => a[0].localeCompare(b[0]));
    orderedEntries.forEach((value) => {
...
export function canonicalizeEnvelope(obj) {
...
export function canonicalizeEvent(obj) {
    return canonicalize(eventOrderAndStringifySubfields(obj));
}
export function strToB64(data) {
    return Buffer.from(data, "utf8").toString("base64");
}
export function b64toStr(data) {
...
export function getHashPrefix(hash, len = 5) {
