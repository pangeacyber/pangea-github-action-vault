...
export default class UserProfile extends BaseService {
     ...
     * ```
     */
    getProfile(data: AuthN.User.Profile.Get.EmailRequest | AuthN.User.Profile.Get.IDRequest | AuthN.User.Profile.Get.UsernameRequest): Promise<PangeaResponse<AuthN.User.Profile.GetResult>>;
    /**
     * @summary Update user
     ...
     * ```
     */
    update(data: AuthN.User.Profile.Update.EmailRequest | AuthN.User.Profile.Update.IDRequest | AuthN.User.Profile.Update.UsernameRequest): Promise<PangeaResponse<AuthN.User.Profile.UpdateResult>>;
}
