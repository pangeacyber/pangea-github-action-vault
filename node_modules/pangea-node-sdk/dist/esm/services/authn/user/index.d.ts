...
export default class User extends BaseService {
     ...
     * });
     */
    delete(request: AuthN.User.Delete.EmailRequest | AuthN.User.Delete.IDRequest | AuthN.User.Delete.UsernameRequest): Promise<PangeaResponse<{}>>;
    /**
     * @summary Create User
     ...
     * ```
     */
    update(request: AuthN.User.Update.EmailRequest | AuthN.User.Update.IDRequest | AuthN.User.Update.UsernameRequest): Promise<PangeaResponse<AuthN.User.UpdateResult>>;
    /**
     * @summary Invite User
