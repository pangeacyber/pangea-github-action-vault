...
import { AuthN, PangeaToken } from "../../../types.js";
export default class Agreements extends BaseService {
     ...
     * ```
     */
    create(request: AuthN.Agreements.CreateRequest): Promise<PangeaResponse<AuthN.Agreements.CreateResult>>;
    /**
     ...
     * ```
     */
    delete(request: AuthN.Agreements.DeleteRequest): Promise<PangeaResponse<AuthN.Agreements.DeleteResult>>;
    /**
     ...
     * ```
     */
    update(request: AuthN.Agreements.UpdateRequest): Promise<PangeaResponse<AuthN.Agreements.UpdateRequest>>;
    /**
     ...
     * ```
     */
    list(request?: AuthN.Agreements.ListRequest): Promise<PangeaResponse<AuthN.Agreements.ListResult>>;
}
