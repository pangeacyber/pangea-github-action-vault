...
export default class ClientSession extends BaseService {
     ...
     * ```
     */
    list(token: string, options?: AuthN.Client.Session.ListOptions): Promise<PangeaResponse<AuthN.Session.ListResult>>;
    /**
     ...
     * ```
     */
    refresh(refreshToken: string, { user_token }: AuthN.Client.Session.RefreshOptions): Promise<PangeaResponse<AuthN.Client.Session.RefreshResult>>;
}
