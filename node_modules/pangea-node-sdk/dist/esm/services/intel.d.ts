...
import { Intel, PangeaToken } from "../types.js";
/**
...
export declare class FileIntelService extends BaseService {
     ...
     * ```
     */
    hashReputationBulk(hashes: string[], hashType: string, options?: Intel.File.ReputationOptions): Promise<PangeaResponse<Intel.File.ReputationBulkResult>>;
    /**
     ...
     * ```
     */
    filepathReputationBulk(filepaths: string[], options?: Intel.File.ReputationOptions): Promise<PangeaResponse<Intel.File.ReputationBulkResult>>;
}
/**
...
export declare class DomainIntelService extends BaseService {
     ...
     * ```
     */
    reputationBulk(domains: string[], options?: Intel.Domain.ReputationOptions): Promise<PangeaResponse<Intel.Domain.ReputationBulkResult>>;
    /**
     * @summary WhoIs
...
export declare class IPIntelService extends BaseService {
     ...
     * ```
     */
    reputationBulk(ips: string[], options?: Intel.IP.ReputationOptions): Promise<PangeaResponse<Intel.IP.ReputationBulkResult>>;
    /**
     * @summary Geolocate
     ...
     * ```
     */
    geolocateBulk(ips: string[], options?: Intel.IP.GeolocateOptions): Promise<PangeaResponse<Intel.IP.GeolocateBulkResult>>;
    /**
     * @summary Domain
     ...
     * ```
     */
    getDomainBulk(ips: string[], options?: Intel.IP.DomainOptions): Promise<PangeaResponse<Intel.IP.DomainBulkResult>>;
    /**
     * @summary VPN
     ...
     * ```
     */
    isVPNBulk(ips: string[], options?: Intel.IP.VPNOptions): Promise<PangeaResponse<Intel.IP.VPNBulkResult>>;
    /**
     * @summary Proxy
     ...
     * ```
     */
    isProxyBulk(ips: string[], options?: Intel.IP.ProxyOptions): Promise<PangeaResponse<Intel.IP.ProxyBulkResult>>;
}
/**
...
export declare class URLIntelService extends BaseService {
     ...
     * ```
     */
    reputationBulk(urls: string[], options?: Intel.URL.ReputationOptions): Promise<PangeaResponse<Intel.URL.ReputationBulkResult>>;
}
/**
...
export declare class UserIntelService extends BaseService {
     ...
     * ```
     */
    userBreachedBulk(request: Intel.User.User.BreachedBulkRequest): Promise<PangeaResponse<Intel.User.User.BreachedBulkResult>>;
    /**
     ...
     * ```
     */
    passwordBreachedBulk(hashType: Intel.HashType, hashPrefixes: string[], options: Intel.User.Password.BreachedOptions): Promise<PangeaResponse<Intel.User.User.BreachedBulkResult>>;
    /**
     ...
     * ```
     */
    breach(request: Intel.User.BreachRequest): Promise<PangeaResponse<Intel.User.BreachResult>>;
