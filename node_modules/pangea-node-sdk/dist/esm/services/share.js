...
import { getFileUploadParams } from "../index.js";
...
class ShareService extends BaseService {
    ...
    requestUploadURL(request) {
        if (request.transfer_method === TransferMethod.POST_URL &&
            ...
            throw new PangeaErrors.PangeaError(`When transfer_method is ${request.transfer_method}, crc32c, sha256 and size must be set. Set them or use transfer_method ${TransferMethod.PUT_URL}`);
        }
