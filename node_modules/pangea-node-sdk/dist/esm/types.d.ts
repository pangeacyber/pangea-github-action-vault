...
export declare namespace AIGuard {
...
export declare namespace PromptGuard {
    interface Message {
        role: string;
        content: string;
    }
...
export declare namespace Intel {
    ...
    namespace User {
        ...
        namespace User {
            ...
            interface BreachedBulkOptions extends Intel.Options {
                /** Earliest date for search. */
                start?: string;
                /** Latest date for search. */
                end?: string;
            ...
            interface BreachedEmailBulkRequest extends BreachedBulkOptions {
                emails: string[];
            }
            interface BreachedUsernameBulkRequest extends BreachedBulkOptions {
                usernames: string[];
            }
            interface BreachedDomainBulkRequest extends BreachedBulkOptions {
                domains: string[];
            }
            interface BreachedIPBulkRequest extends BreachedBulkOptions {
                ips: string[];
            }
            interface BreachedPhoneBulkRequest extends BreachedBulkOptions {
                phone_numbers: string[];
            }
            type BreachedBulkRequest = BreachedEmailBulkRequest | BreachedIPBulkRequest | BreachedPhoneBulkRequest | BreachedUsernameBulkRequest | BreachedDomainBulkRequest;
...
export declare namespace Vault {
    ...
    interface UpdateResult extends ItemData {
    }
    ...
    namespace Common {
        interface StoreRequest extends GenerateStoreOptions {
            /** The type of the item */
            type: Vault.ItemType;
            /** The name of this item */
            name: string;
        }
        interface GenerateRequest extends GenerateStoreOptions {
            /** The type of the item */
            type?: Vault.ItemType;
            /** The name of this item */
            name: string;
        ...
        interface RotateResult extends ItemData {
        }
    }
    namespace Secret {
        const Algorithm: {
        ...
        interface StoreRequest extends Common.StoreRequest {
            /** The secret value */
            secret?: string;
        ...
        interface StoreResult extends ItemData {
            /** The secret value */
            secret?: string;
            /** The Pangea Token value */
            token?: string;
    ...
    namespace Asymmetric {
        interface GenerateRequest extends Common.GenerateRequest {
            /** The algorithm of the key */
            algorithm: Vault.AsymmetricAlgorithm;
            /** The purpose of the key */
            purpose: Vault.KeyPurpose;
        }
        interface GenerateResult extends ItemData {
            /** The algorithm of the key */
            algorithm: string;
            /** The purpose of the key */
            purpose: string;
    ...
    namespace Folder {
        ...
        interface CreateResult extends ItemData {
        }
    }
}
...
export declare namespace Share {
    ...
    interface ShareLinkCreateRequest {
    ...
    interface ShareLinkCreateResult {
        share_link_objects: ShareLinkItem[];
    }
    interface ShareLinkGetRequest {
        /** The ID of a share link. */
        id: string;
    }
    interface ShareLinkGetResult {
        share_link_object: ShareLinkItem;
    }
    interface ShareLinkListFilter {
        /** Only records where id equals this value. */
        id?: string;
    ...
    interface ShareLinkListRequest {
        /** The bucket to use, if not the default. */
        bucket_id?: string;
    ...
    interface ShareLinkDeleteRequest {
        /** The bucket to use, if not the default. */
        bucket_id?: string;
        ids: string[];
    }
    interface ShareLinkDeleteResult {
        share_link_objects: ShareLinkItem[];
    }
    interface ShareLinkSendItem {
        /** The ID of a share link. */
        id: string;
        /** An email address. */
        email: string;
    }
    interface ShareLinkSendRequest {
        links: ShareLinkSendItem[];
        /** An email address. */
        sender_email: string;
        sender_name?: string;
    }
    interface ShareLinkSendResult {
        share_link_objects: ShareLinkItem[];
    }
}
