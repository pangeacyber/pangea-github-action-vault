...
import { AuthZ, PangeaToken } from "../types.js";
/**
 * AuthZService class provides methods for interacting with the AuthZ Service
 * @extends BaseService
 */
declare class AuthZService extends BaseService {
    /**
     ...
     * ```
     */
    listResources(request: AuthZ.ListResourcesRequest): Promise<PangeaResponse<AuthZ.ListResourcesResult>>;
    /**
     ...
     * ```
     */
    listSubjects(request: AuthZ.ListSubjectsRequest): Promise<PangeaResponse<AuthZ.ListSubjectsResult>>;
}
