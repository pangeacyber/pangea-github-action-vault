...
import { PangeaToken, Redact } from "../types.js";
 ...
 * @extends BaseService
 */
declare class RedactService extends BaseService {
    /**
     ...
     * @summary Redact
     */
    constructor(token: PangeaToken, config: PangeaConfig, options?: RedactOptions);
    /**
     * @summary Redact
     ...
     * ```
     */
    redact(text: string, options?: Redact.TextOptions): Promise<PangeaResponse<Redact.TextResult>>;
    /**
     ...
     * ```
     */
    redactStructured(data: object, options?: Redact.StructuredOptions): Promise<PangeaResponse<Redact.StructuredResult>>;
    /**
     * @summary Unredact
     ...
     */
    unredact<O = object>(request: Redact.UnredactRequest<O>): Promise<PangeaResponse<Redact.UnredactResult<O>>>;
}
