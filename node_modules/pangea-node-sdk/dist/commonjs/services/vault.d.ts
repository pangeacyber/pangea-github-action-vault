...
import { PangeaToken, Vault } from "../types.js";
/**
 * VaultService class provides methods for interacting with the Vault Service
 * @extends BaseService
 */
declare class VaultService extends BaseService {
    /**
     ...
     * ```
     */
    stateChange(id: string, state: Vault.ItemVersionState, options?: Vault.StateChangeOptions): Promise<PangeaResponse<Vault.StateChangeResult>>;
    /**
     * @summary Delete
     ...
     * ```
     */
    delete(id: string): Promise<PangeaResponse<Vault.DeleteResult>>;
    /**
     * @summary Retrieve
     ...
     * ```
     */
    getItem(id: string, options?: Vault.GetOptions): Promise<PangeaResponse<Vault.GetResult>>;
    /**
     * @summary List
     ...
     * ```
     */
    list(options?: Vault.ListOptions): Promise<PangeaResponse<Vault.ListResult>>;
    /**
     * @summary Update
     ...
     * ```
     */
    update(id: string, options?: Vault.UpdateOptions): Promise<PangeaResponse<Vault.UpdateResult>>;
    /**
     ...
     * ```
     */
    secretStore(secret: string, name: string, options?: Vault.Secret.StoreOptions): Promise<PangeaResponse<Vault.Secret.StoreResult>>;
    /**
     ...
     * ```
     */
    pangeaTokenStore(pangeaToken: string, name: string, options?: Vault.Secret.StoreOptions): Promise<PangeaResponse<Vault.Secret.StoreResult>>;
    /**
     ...
     * ```
     */
    secretRotate(id: string, secret: string, options?: Vault.Secret.Secret.RotateOptions): Promise<PangeaResponse<Vault.Secret.RotateResult>>;
    /**
     ...
     * ```
     */
    pangeaTokenRotate(id: string, rotation_grace_period: string): Promise<PangeaResponse<Vault.Secret.RotateResult>>;
    /**
     ...
     * ```
     */
    symmetricGenerate(algorithm: Vault.SymmetricAlgorithm, purpose: Vault.KeyPurpose, name: string, options?: Vault.Symmetric.GenerateOptions): Promise<PangeaResponse<Vault.Symmetric.GenerateResult>>;
    /**
     ...
     * ```
     */
    asymmetricGenerate(algorithm: Vault.AsymmetricAlgorithm, purpose: Vault.KeyPurpose, name: string, options?: Vault.Asymmetric.GenerateOptions): Promise<PangeaResponse<Vault.Asymmetric.GenerateResult>>;
    /**
     ...
     * ```
     */
    asymmetricStore(privateKey: Vault.EncodedPrivateKey, publicKey: Vault.EncodedPublicKey, algorithm: Vault.AsymmetricAlgorithm, purpose: Vault.KeyPurpose, name: string, options?: Vault.Asymmetric.StoreOptions): Promise<PangeaResponse<Vault.Asymmetric.StoreResult>>;
    /**
     ...
     * ```
     */
    symmetricStore(key: string, algorithm: Vault.SymmetricAlgorithm, purpose: Vault.KeyPurpose, name: string, options?: Vault.Asymmetric.StoreOptions): Promise<PangeaResponse<Vault.Symmetric.StoreResult>>;
    /**
     * @summary Key rotate
     ...
     * ```
     */
    keyRotate(id: string, options?: Vault.Key.RotateOptions): Promise<PangeaResponse<Vault.Key.RotateResult>>;
    /**
     * @summary Encrypt
     ...
     * ```
     */
    encrypt(id: string, plainText: string): Promise<PangeaResponse<Vault.Symmetric.EncryptResult>>;
    /**
     * @summary Decrypt
     ...
     * ```
     */
    decrypt(id: string, cipherText: string, options?: Vault.Symmetric.DecryptOptions): Promise<PangeaResponse<Vault.Symmetric.DecryptResult>>;
    /**
     * @summary Sign
     ...
     * ```
     */
    sign(id: string, message: string): Promise<PangeaResponse<Vault.Asymmetric.SignResult>>;
    /**
     * @summary Verify
     ...
     * ```
     */
    verify(id: string, message: string, signature: string, options?: Vault.Asymmetric.VerifyOptions): Promise<PangeaResponse<Vault.Asymmetric.VerifyResult>>;
    /**
     ...
     * ```
     */
    jwkGet(id: string, options?: Vault.JWK.GetOptions): Promise<PangeaResponse<Vault.JWK.GetResult>>;
    /**
     * @summary JWT Sign
     ...
     * ```
     */
    jwtSign(id: string, payload: string): Promise<PangeaResponse<Vault.JWT.SignResult>>;
    /**
     * @summary JWT Verify
     ...
     * ```
     */
    jwtVerify(jws: string): Promise<PangeaResponse<Vault.JWT.VerifyResult>>;
    /**
     * @summary Create
     ...
     * ```
     */
    folderCreate(request: Vault.Folder.CreateRequest): Promise<PangeaResponse<Vault.Folder.CreateResult>>;
    /**
     ...
     * ```
     */
    encryptStructured<O>(request: Vault.Key.EncryptStructuredRequest<O>): Promise<PangeaResponse<Vault.Key.EncryptStructuredResult<O>>>;
    /**
     ...
     * ```
     */
    decryptStructured<O>(request: Vault.Key.EncryptStructuredRequest<O>): Promise<PangeaResponse<Vault.Key.EncryptStructuredResult<O>>>;
    /**
     ...
     * ```
     */
    encryptTransform(request: Vault.Key.EncryptTransformRequest): Promise<PangeaResponse<Vault.Key.EncryptTransformResult>>;
    /**
     ...
     * ```
     */
    decryptTransform(request: Vault.Key.DecryptTransformRequest): Promise<PangeaResponse<Vault.Key.DecryptTransformResult>>;
    /**
     * @summary Export
     ...
     * ```
     */
    export(request: Vault.ExportRequest): Promise<PangeaResponse<Vault.ExportResult>>;
}
