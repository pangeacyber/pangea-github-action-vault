...
import { Audit, PangeaToken } from "../types.js";
/**
...
declare class AuditService extends BaseService {
     ...
     * @summary Audit
     */
    constructor(token: PangeaToken, config: PangeaConfig, tenantID?: string, configID?: string);
    /**
     ...
     * ```
     */
    results(id: string, limit: number | undefined, offset: number | undefined, options: Audit.SearchOptions, queryOptions?: Audit.ResultOptions): Promise<PangeaResponse<Audit.ResultResponse>>;
    /**
