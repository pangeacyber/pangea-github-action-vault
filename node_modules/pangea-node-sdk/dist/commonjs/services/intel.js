...
exports.UserIntelService = exports.URLIntelService = exports.IPIntelService = exports.DomainIntelService = exports.FileIntelService = void 0;
 ...
 */
class UserIntelService extends base_js_1.default {
    /**
    ...
    static isPasswordBreached(response, hash) {
        if (response.result.raw_data === undefined) {
            throw new errors_js_1.PangeaErrors.PangeaError("Need raw data to check if hash is breached. Send request with raw=true");
        }
        const hashData = response.result.raw_data[hash];
        if (hashData != undefined) {
            // If hash is present in raw data, it's because it was breached
            return types_js_1.Intel.User.Password.PasswordStatus.BREACHED;
        }
            ...
            return types_js_1.Intel.User.Password.PasswordStatus.INCONCLUSIVE;
        }
        else {
            return types_js_1.Intel.User.Password.PasswordStatus.UNBREACHED;
        }
    }
}
exports.UserIntelService = UserIntelService;
