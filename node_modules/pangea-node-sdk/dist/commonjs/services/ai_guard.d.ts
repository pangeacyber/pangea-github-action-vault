...
/** AI Guard API client. */
export declare class AIGuardService extends BaseService {
    /**
    ...
    guardText(request: {
        text: string;
    } & AIGuard.TextGuardRequest): Promise<PangeaResponse<AIGuard.TextGuardResult<void>>>;
    /**
     * @summary Text Guard for scanning LLM inputs and outputs
     * @description Analyze and redact text to avoid manipulation of the model,
     *   addition of malicious content, and other undesirable data transfers.
    ...
    guardText<T>(request: {
        messages: T;
    } & AIGuard.TextGuardRequest): Promise<PangeaResponse<AIGuard.TextGuardResult<T>>>;
    /**
     * @summary Text Guard for scanning LLM inputs and outputs
     * @description Analyze and redact text to avoid manipulation of the model,
     *   addition of malicious content, and other undesirable data transfers.
