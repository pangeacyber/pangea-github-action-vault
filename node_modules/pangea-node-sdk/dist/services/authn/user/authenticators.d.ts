...
export default class UserAuthenticators extends BaseService {
     ...
     * ```
     */
    delete(request: AuthN.User.Authenticators.Delete.EmailRequest | AuthN.User.Authenticators.Delete.IDRequest | AuthN.User.Authenticators.Delete.UsernameRequest): Promise<PangeaResponse<{}>>;
    /**
     ...
     * ```
     */
    list(request: AuthN.User.Authenticators.ListRequest): Promise<PangeaResponse<AuthN.User.Authenticators.ListResult>>;
}
