...
export default class UserProfile extends BaseService {
     ...
     * ```
     */
    getProfile(data: AuthN.User.Profile.Get.EmailRequest | AuthN.User.Profile.Get.IDRequest): Promise<PangeaResponse<AuthN.User.Profile.GetResult>>;
    /**
     * @summary Update user
     ...
     * ```
     */
    update(data: AuthN.User.Profile.Update.EmailRequest | AuthN.User.Profile.Update.IDRequest): Promise<PangeaResponse<AuthN.User.Profile.UpdateResult>>;
}
