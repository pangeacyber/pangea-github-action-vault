...
export default class User extends BaseService {
     ...
     * );
     */
    delete(request: AuthN.User.Delete.EmailRequest | AuthN.User.Delete.IDRequest): Promise<PangeaResponse<{}>>;
    /**
     * @summary Create User
     ...
     * ```
     */
    create(email: string, authenticator: string, idProvider: AuthN.IDProvider, { verified, require_mfa, profile, scopes }?: AuthN.User.CreateOptions): Promise<PangeaResponse<AuthN.User.CreateResult>>;
    /**
     * @summary Invite User
     ...
     * ```
     */
    invite(inviter: string, email: string, callback: string, state: string, options?: AuthN.User.InviteOptions): Promise<PangeaResponse<AuthN.User.InviteResult>>;
    /**
     * @summary List Users
     ...
     * ```
     */
    verify(idProvider: AuthN.IDProvider, email: string, authenticator: string): Promise<PangeaResponse<AuthN.User.VerifyResult>>;
    /**
     ...
     * ```
     */
    update(request: AuthN.User.Update.EmailRequest | AuthN.User.Update.IDRequest, options: AuthN.User.Update.Options): Promise<PangeaResponse<AuthN.User.UpdateResult>>;
}
