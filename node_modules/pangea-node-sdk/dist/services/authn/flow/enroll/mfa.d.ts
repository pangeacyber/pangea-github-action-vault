...
export default class FlowEnrollMFA extends BaseService {
     ...
     * ```
     */
    start(flowID: string, mfaProvider: AuthN.MFAProvider, options: AuthN.Flow.Enroll.MFA.StartOptions): Promise<PangeaResponse<AuthN.Flow.Result>>;
    /**
     ...
     * ```
     */
    complete(flowID: string, options: AuthN.Flow.Enroll.MFA.CompleteOptions): Promise<PangeaResponse<AuthN.Flow.Result>>;
}
